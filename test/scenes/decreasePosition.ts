...
decreasePosition.long.withSpread = async (fixture, overrides = {}) => {
  ...
  await handleOrder(fixture, {
    create: { ...params, ...overrides.create },
    execute: { ...getExecuteParams(fixture, { prices: [ priceFeedPrices.wnt.withSpread, priceFeedPrices.usdc] }), ...overrides.execute },
  });
};
...
decreasePosition.long.positivePnl = async (fixture, overrides = {}) => {
  ...
  await handleOrder(fixture, {
    create: { ...params, ...overrides.create },
    execute: { ...getExecuteParams(fixture, { prices: [ priceFeedPrices.wnt.increased, priceFeedPrices.usdc] }), ...overrides.execute },
  });
};
...
decreasePosition.long.negativePnl = async (fixture, overrides = {}) => {
  ...
  await handleOrder(fixture, {
    create: { ...params, ...overrides.create },
    execute: { ...getExecuteParams(fixture, { prices: [ priceFeedPrices.wnt.decreased, priceFeedPrices.usdc,] }), ...overrides.execute },
  });
};
...
decreasePosition.long.positivePnl.withSpread = async (fixture, overrides = {}) => {
  ...
  await handleOrder(fixture, {
    create: { ...params, ...overrides.create },
    execute: {
      ...getExecuteParams(fixture, { prices: [priceFeedPrices.wnt.increased.withSpread, priceFeedPrices.usdc, ] }),
      ...overrides.execute,
    },
  });
};
...
decreasePosition.long.negativePnl.withSpread = async (fixture, overrides = {}) => {
  ...
  await handleOrder(fixture, {
    create: { ...params, ...overrides.create },
    execute: {
      ...getExecuteParams(fixture, { prices: [priceFeedPrices.wnt.decreased.withSpread, priceFeedPrices.usdc, ] }),
      ...overrides.execute,
    },
  });
};
